...
namespace NChildTree
{
    public class Tree<T>
    {
        ...
        public void Insert()
        {
            ...
            Console.Write("Enter Value of Root Node: ");
            value = int.Parse(Console.ReadLine());
            Console.Write("Enter Value of Parent: ");
            int parent = int.Parse(Console.ReadLine());
            // Checking if the parent entered is in the tree
            if (Contains(parent))
            {
                // if value of newNode is not already in the tree then only we Insert. i.e. A tree cannot have duplicate values
                ...
                {
                    Console.WriteLine("Tree cannot have same value multiple times");
                }
            }
            else
            {
                Console.WriteLine("No such parent present in Tree");
            }
        ...
        public void GetElementByValue()
        {
            ...
            {
                Console.WriteLine("No such element in tree");
            }
        }
        ...
        public void GetElementByLevel()
        {
            ...
            Console.Write("\nEnter Level : ");
            int levelTree = int.Parse(Console.ReadLine());
            ...
            {
                Console.WriteLine("The Max Level in this Tree is 3.");
            }
        }
        ...
        public void Delete()
        {
            ...
            Console.WriteLine("All Leaf Node Deleted!");
        }
